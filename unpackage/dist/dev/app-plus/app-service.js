                      ...
                      "view",
                      {
                        ...
                        on: {
                          click: function($event) {
                            ...
                            return _vm.fnNavigatePage(item.url, index)
                          }
                        }
                      },
                      [
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _mixPulldownRefresh = _interopRequireDefault(__webpack_require__(/*! @/components/mix-pulldown-refresh/mix-pulldown-refresh */ 5));\nvar _index = __webpack_require__(/*! @/utils/index.js */ 14);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { mixPulldownRefresh: _mixPulldownRefresh.default }, data: function data() {return { enableScroll: true, list: [] };}, onShow: function onShow() {__f__(\"log\", \"development\",  true ? '开发环境' : undefined, \" at pages/index/index.vue:36\");}, methods: { //下拉刷新\n    onPulldownReresh: function onPulldownReresh() {var _this = this; // http.post('/student/User/phoneLogin', {\n      // \tphone: '17521192130',\n      // \tphone_verify_code: '0000'\n      // }).then(res => {\n      // \thttp.post('/student/Message/stat', {}).then(res => {\n      // \t\tconsole.log(res.data.stat,'res');\n      // \t}).catch(err => {\n      // \t\tconsole.log(err,'err');\n      // \t})\n      // })\n      setTimeout(function () {_this.$refs.mixPulldownRefresh && _this.$refs.mixPulldownRefresh.endPulldownRefresh();}, 400);}, //页面滚动到最底部\n    loadMore: function loadMore() {\n      __f__(\"log\", '@@@@@@@@@@@页面滚动到底部@@@@@@@@@@@@@@@', \" at pages/index/index.vue:58\");\n    },\n\n    //设置scroll-view是否允许滚动，在小程序里下拉刷新时避免列表可以滑动\n    setEnableScroll: function setEnableScroll(enable) {\n      if (this.enableScroll !== enable) {\n        this.enableScroll = enable;\n      }\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 13)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///12\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\nvar _index = __webpack_require__(/*! @/utils/index.js */ 14);var _default =\n{\n  globalData: {\n    http: _index.http },\n\n  data: function data() {\n    return {};\n\n  },\n  onLaunch: function onLaunch() {\n    //监听消息推送\n    plus.push.addEventListener('click', function (msg) {\n      uni.showToast({\n        title: JSON.stringify(msg.content),\n        icon: 'none',\n        duration: 3000 });\n\n    }, true);\n  },\n  onShow: function onShow() {\n  },\n  onHide: function onHide() {\n  },\n  methods: {} };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///27\n");
